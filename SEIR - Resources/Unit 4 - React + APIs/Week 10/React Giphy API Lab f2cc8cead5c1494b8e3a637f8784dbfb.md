...
![](https://media.giphy.com/media/i2njWo9AQE1pVo7H5x/giphy.gif)
...
To interact with the Giphy API, you will need to sign up for an account at [https://giphy.com/](https://giphy.com/). Once you have created an account, follow the steps below:

- Navigate to [https://developers.giphy.com/](https://developers.giphy.com/) and click the `Get Started` button
...
> These Search Endpoint Docs have the details
> 
