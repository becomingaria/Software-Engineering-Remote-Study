...
The term *API* is quite vague and used within several contexts.

First, it's an acronym that stands for **Application Programming Interface**.

*Application Programming Interfaces* define the set of methods and properties made available by a library, a framework, an operating system, or any piece of software that programmers can use to access the software's functionality.
...
[Link](https://i.imgur.com/Hflu0K0.png)

![](https://i.imgur.com/Hflu0K0.png)
...
### The *user* and *user repositories* Endpoints
...
- Make sure you are logged in to your personal GitHub account and go to *settings*, then click *Developer settings* on the left.
- Now select *Personal access tokens* from the menu at the bottom-left.
- Click the *Generate new token* button.
- Enter a description and click the *Generate token* button at the bottom. There is no need to select any of the scopes listed.
