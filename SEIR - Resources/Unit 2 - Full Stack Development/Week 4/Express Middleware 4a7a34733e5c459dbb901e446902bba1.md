...
- Use  Middleware and HTML Forms to Create Data on the Server
- Use  Middleware and HTML Forms to Delete Data on the Server
...
| new + create | Display a form to add a new data resource<br>+<br>Handle the form being submitted and create the data resource |
| show | Display a single data resource |
| delete | Delete a single data resource |
| edit + update | Display a form to edit an existing data resource<br>+<br>Handle the form being submitted and update the data resource |
