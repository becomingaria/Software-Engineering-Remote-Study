...
- Use  Middleware and HTML Forms to Update on the Server
...
We will review this implementation after the exercise, for now try relying on the provided hints and writing the code on your own.
