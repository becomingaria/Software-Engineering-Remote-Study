...
1. Move into your `~/sei/homework` folder.
2. Fork and clone this repo and follow the instructions found within the linked notion documents:
    
    [https://github.com/SEIR-221-Resources/Dev-Skills-Lab](https://github.com/SEIR-221-Resources/Dev-Skills-Lab)
    
3. In the cloned lab directory, scaffold a new app named `express-dev-skills` using express generator (don't forget the `e` option).
