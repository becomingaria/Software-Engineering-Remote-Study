...
- Implement  (Read One) Functionality

## 1. Setup

To get ready for this lesson, simply `cd ~/sei/lessons`.
...
In fact, many web frameworks such as Ruby on Rails, [ASP.net](http://asp.net/), Spring MVC (Java), and others implement the MVC architectural pattern.
...
- The renaming of **`routes/users.js`** to **`routes/todos.js`** requires a couple of changes in **`server.js`**
- Both when the router module is being *required*:
...
However, clicking one of those links will display a<br>*Not Found 404*<br>error - this means that there is no route on the server that matches the HTTP request.
...
### 🚀 - Want to display the current day for your timezone?
...
// sources
// day formatting - https://stackoverflow.com/questions/57187691/javascript-how-to-verify-day-by-getday-when-using-timezone
// finding timezone offset - https://stackoverflow.com/questions/1091372/getting-the-clients-time-zone-and-offset-in-javascript
```