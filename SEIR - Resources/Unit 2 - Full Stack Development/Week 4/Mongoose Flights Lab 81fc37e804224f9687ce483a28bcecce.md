...
1. Fork and Clone the lab and cd into the repo directory:
    
    [https://github.com/SEIR-221-Resources/Mongoose-Flights-Lab](https://github.com/SEIR-221-Resources/Mongoose-Flights-Lab)
    
2. Use express generator to create a `mongoose-flights` project. `express -ef .` Be sure to install the Node modules after you `cd` into the project.
3. Rename **app.js** to **server.js** and make the necessary change inside of `bin/www`.
4. Install the `dotenv` module and initalize the local env file
...
10. Optionally set up partial templates.
...
2. Style the `index` and `new` views.
