# Intro to FS Development

![](https://i.imgur.com/PE14J3Y.jpg)
...
![](https://i.imgur.com/FKGehuM.jpg)

### Web Technology Stack - Unit 3

In Unit 3, we'll learn:

![](https://i.imgur.com/GuogOfX.png)

![](https://i.imgur.com/MjX4aD7.png)

### Web Technology Stack - Unit 4

In Unit 4, we go full MERN-stack:

![](https://i.imgur.com/jlKEj7F.png)

## 4. Client/Server Architecture

![](https://i.imgur.com/clxiqnO.png)
...
Now let's browse to YourCourse's site by typing [**yourcourse.dev**](http://yourcourse.dev/) in the address bar...

Wow! Each one of those lines represents a separate HTTP request made to a server! Find the line in the left-side pane with [**yourcourse.dev**](https://yourcourse.dev/) and click on it:

![](https://i.imgur.com/fuED3VM.png)
...
> Note: There dozens of additional http verbs that you will likely encounter in your career. It is helpful to be aware of the most common http verbs and to understand how they can be used. See this documentation from Mozilla's developer network that explains the 9 most common http verbs. If you choose to dig deeper and investigate the http protocol specifics, you'll see that there are about 39 different http verbs in http1.1. Even if an http verb is included in the protocol spec, that doesn't mean that all http clients will support all of these verbs, you most likely will not encounter the majority these verbs in your career, but it is helpful to understand how these protocols are designed and utilized.
