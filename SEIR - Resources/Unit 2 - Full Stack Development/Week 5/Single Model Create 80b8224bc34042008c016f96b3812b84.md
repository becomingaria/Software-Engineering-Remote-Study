...
In the upcoming *Mongoose - Referencing Related Data* lesson, we'll learn how to implement a many-to-many data relationship using referencing.
...
Creating *movies* was the first major piece of functionality we added to mongoose-movies.  However, mongoose-movies now needs functionality to similarly create *performers* - and this provides an opportunity for repetition!
...
A new data resource, such as *performers*, typically has a dedicated set of modules, etc.
