...
1. Write the code for each exercise. Do not use a semicolon at the end of any `.then()` method calls, otherwise the included `.then()` at the end of the code will not properly shut down the app.
