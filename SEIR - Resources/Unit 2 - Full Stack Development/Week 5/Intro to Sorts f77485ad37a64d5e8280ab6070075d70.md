...
With a partner, acquire a set of playing cards. ([Check out this handy app!](https://deck.of.cards/)) Assign one person to move cards (the "card person / driver ") and one (or two) person(s) to be in charge of comparisons (the "comparison person / navigator").

### What to Do

The card person should lay 8 cards out in a line on the table. The card person's goal is to interact with the cards .
