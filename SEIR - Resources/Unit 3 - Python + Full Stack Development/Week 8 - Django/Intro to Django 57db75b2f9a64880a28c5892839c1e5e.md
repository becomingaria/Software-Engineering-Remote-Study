...
<img src="[https://i.imgur.com/rA4BtNv.png](https://i.imgur.com/rA4BtNv.png)">
...
Other frameworks, such as Django and [ASP.NET](http://asp.net/) Core, use just the URL when defining a route, ignoring the HTTP verb.

That's why the Python modules used to define routes in Django are named [**urls.py**](http://urls.py/) (see diagram above).
...
[Link to Final Tutorial Code](../../../labs/unit-3-python/django-tutorial-final/README.md)
