...
You're given an array of dictionaries that contain each state name and capital. Copy the code below into a [`states.py`](http://states.py) file. 

Create a [`main.py`](http://main.py) and add this code to the top of the file.

```python
from states import states

# an slice of state dictionaries
print(states[:3])
```
