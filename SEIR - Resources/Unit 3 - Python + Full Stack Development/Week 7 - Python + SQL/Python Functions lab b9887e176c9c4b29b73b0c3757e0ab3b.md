...
You may write the functions in a `.py` file or use a Python repl in [repl.it](http://repl.it/)
...
## Challenge Solutions (do not peek unless you are stuck or finished)
