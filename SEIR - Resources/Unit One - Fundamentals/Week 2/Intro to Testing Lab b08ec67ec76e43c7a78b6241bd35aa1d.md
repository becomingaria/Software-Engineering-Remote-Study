...
[https://github.com/SEIR-221-Resources/testing-lab](https://github.com/SEIR-221-Resources/testing-lab)
...
> Note: Remember that base cases are test cases where our inputs are normal expected inputs
> 

For this function, we should write two base case tests:

- a test case for a string that *does* have the same first and last character
- a test case for a string that *doesn't* have the same first and last character
...
> Note: Remember that edge cases are test cases where our inputs are at the edges of our allowed input range
> 
