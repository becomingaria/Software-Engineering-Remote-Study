...
- When an element has a CSS property of `display: flex;`, that element becomes a Flex C__________.
    
    **Container**
    
- When an element has a CSS property of `display: flex;`, its direct children become Flex I_____.
...
- Is it `justify-content` or `align-items` that controls the alignment along the main axis?
