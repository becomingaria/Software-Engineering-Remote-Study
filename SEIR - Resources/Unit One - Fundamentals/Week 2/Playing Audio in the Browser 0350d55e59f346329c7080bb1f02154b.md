...
<img src="[https://i.imgur.com/Ae7LmVX.jpg](https://i.imgur.com/Ae7LmVX.jpg)">
...
2. The *HTMLAudioElement* DOM interface that can be used to create an audio element in code using JS using the [Audio class](https://developer.mozilla.org/en-US/docs/Web/API/HTMLAudioElement/Audio).

### Code Example

Let's review the code in [this repl shown below](https://replit.com/@SEIStudent/Playing-Audio-in-the-Browser#index.html):

<img src="[https://i.imgur.com/tphSSfE.png](https://i.imgur.com/tphSSfE.png)">
...
<img src="[https://i.imgur.com/erzfdzx.png](https://i.imgur.com/erzfdzx.png)">
