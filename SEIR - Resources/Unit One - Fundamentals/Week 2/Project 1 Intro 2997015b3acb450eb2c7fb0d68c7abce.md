...
[https://github.com/SEIR-221-Resources/Project-1-Intro](https://github.com/SEIR-221-Resources/Project-1-Intro)
...
- You will share as an issue on the above repo:
    
    ☐ Your choice of game.
    
    ☐ A wireframe of your "main" game screen.
    
    ☐ Pseudocode for the overall game play. The pseudocode does not need to go into extreme detail but should identify state, node references, and basic MVP game loop.
...
5. **Simon**
    - Requires asynchronous interactions and [Audio playback](Playing%20Audio%20in%20the%20Browser%200350d55e59f346329c7080bb1f02154b.md)
...
- Review and check regularly the  to ensure that your project is going to meet the minimum requirements.
...
- Your instructors will endeavor to deliver your code review by EOD a week from the presentation date.
