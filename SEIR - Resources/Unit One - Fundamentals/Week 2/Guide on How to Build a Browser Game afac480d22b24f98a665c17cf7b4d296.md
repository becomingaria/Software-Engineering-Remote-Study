...
<img src="[https://i.imgur.com/XagTF9B.jpg](https://i.imgur.com/XagTF9B.jpg)">
...
<img src="[https://i.imgur.com/jayaYY2.png](https://i.imgur.com/jayaYY2.png)">
...
1. **Analyze the app's functionality**
    ...
    User stories follow this template:<br>**As a [role], I want [feature] because [reason]**.<br>Example user story: *As a player, I want to see a list of high-scores so that I know what I have to score to make the list*.
