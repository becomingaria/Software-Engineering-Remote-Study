...
1. Fork and clone the repo linked below: "Array Methods Lab".
    
    [https://github.com/SEIR-221-Resources/Array-Methods-Lab](https://github.com/SEIR-221-Resources/Array-Methods-Lab)
    
2. Copy the code below into the `main.js` file and complete each exercise.
...
Yes, this lab is a deliverable.  Please make a pull request for the  "Array Methods Lab" repo.
