...
![Untitled](Intro%20to%20the%20Command%20Line/Untitled.png)
...
![Untitled](Intro%20to%20the%20Command%20Line/Untitled%201.png)
...
`pwd` will print the current working directory. It shows you a `path`.

This `path` shows you where you are currently located in the filesystem.

It's like sending up a flare or homing beacon, where you can see how far you have
...
their current location. Where is YourCourse? Two blocks up 15th street
from where you are now.

An example of an _absolute_ path to YourCourse could be 1133 15th St NW,
...
- Example:
    - `cat readme.md`
        - writes the contents of [readme.md](http://readme.md/) to the console
...
[CLI Practice](Intro%20to%20the%20Command%20Line/CLI%20Practice%2024ccefa456084722b57b24ec9545e669.md)

🚀 **HFM [CLI Activity](../../../labs/unit-1-fundamentals/kitchen-organizer/README.md)**

## Time to Practice!

There are MANY more CLI commands to learn, more than we could cover in an entire day. Check out the [Useful Commands](../../Coding%20Challenges%20Calendar%20d1b9071f988e441a8c9792a876648e89.md) section of the repo for CLI resources
...
The commands we've covered in this lesson will probably account for 80% of your CLI usage. Regardless of how much experience with the command line you have coming in to this class, your next step should be to get really comfortable with it - we're going to spend a lot of time in the command line over the next 12 weeks.

## Additional Practice / Bonus Material

- [Command Line Fu](../../../labs/unit-1-fundamentals/command-line-fu/README.md)
- [Kitchen Organizer](../../../labs/unit-1-fundamentals/kitchen-organizer/README.md)
