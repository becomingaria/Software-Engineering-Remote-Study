...
1. We will create a directory `solar_system_lab` in your `labs` folder
2. Create a file `solar_system.js` in your `solar_system_lab` dir
...
```jsx
console.log(solarSystem[0].ringSystem) //=> false
// solarSystem - the variable storing an array of objects
// solarSystem[0] - the first object in the array
// solarSystem[0].ringSystem - the property 'ringSystem' that returns a boolean.
```
...
> { name: 'Mercury', ringSystem: true, moons: [] }{ name: 'Jupiter', ringSystem: true, moons: [ 'Europa', 'Ganymede', 'Io', 'Callisto' ] }{ name: 'Saturn', ringSystem: true, moons: [ 'Titan', 'Enceladus', 'Rhea', 'Mimas' ] }{ name: 'Uranus', ringSystem: true, moons: [ 'Miranda', 'Titania', 'Ariel', 'Oberon' ] }{ name: 'Neptune', ringSystem: true, moons: [ 'Triton', 'Nereid' ] }

---

## The solar system, part 2

Copy this **object** into your file (it’s big). Remember, this is an **object of objects** not an array of objects. This will be easier to navigate if you bring it over into your code editor.
...
Following the examples shown for part 2, write the commands you would use to do the following:
...
Complete this [advanced object lab, which uses weather forecast data](https://www.notion.so/38318abaafd04c0481ac4155058ed1e7?pvs=21).

---

## B. Sorting an array of objects

Complete this [activity about the Array method `.sort()`](../../../labs/unit-1-fundamentals/sort-activity/README.md) which is very powerful and can be used to sort arrays in a number of ways.
