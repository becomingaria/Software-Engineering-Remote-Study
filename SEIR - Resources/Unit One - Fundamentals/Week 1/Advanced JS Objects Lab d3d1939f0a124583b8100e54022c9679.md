# Advanced JS Objects Lab

# ⛈️ Weather Object Lab

## Let's talk about the weather

Notice that at the bottom of this file under "The Data" section below is an enormous object. It describes the weather in Evanston, IL over a period of 5 days. It's simply too large for a human to read in any reasonable amount of time. Therefore, visit this link: [OpenWeatherMap.org API Documentation](http://openweathermap.org/forecast5#JSON).
...
So, by now you've noticed that you're given the weather data for 3 hour time increments. For this question, write logic to figure out the high and low temp for each day, as well as a description of the weather overall for the day. You will create an object that stores all of it, as follows:
...
1. Write *another* function `printForecast` that iterates over the array returned by `getWeatherArray` and console.logs the 5-day forecast data like this:
...
Thanks OpenWeatherMap for an awesome learning tool. This data came from an API call to one of their endpoints. Material reused according to the [Creative Commons License](https://creativecommons.org/licenses/by-sa/4.0/) as described in the [OpenWeatherMap Terms of Service](https://openweathermap.org/terms).

### The data:

## The Raw Data (click the copy button on the top write)
