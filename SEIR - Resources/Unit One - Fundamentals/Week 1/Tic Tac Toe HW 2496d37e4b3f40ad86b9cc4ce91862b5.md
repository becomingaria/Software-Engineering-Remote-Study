...
This lab is **a DELIVERABLE** - be sure to submit the either the link to your GitHub repo.
...
![](https://i.imgur.com/WXxIvDz.png)

1. After clicking the green `Create repository` button, copy the new repo's URL by clicking the clipboard button:
    
    ![](https://i.imgur.com/KMm8Zq5.png)
    
2. Ensure that you're in your `~/code` folder then clone the repo:
...
3. Lastly, move into the the newly created folder named the same as the repo, e.g., `cd tic-tac-toe`. You're ready to start coding!
