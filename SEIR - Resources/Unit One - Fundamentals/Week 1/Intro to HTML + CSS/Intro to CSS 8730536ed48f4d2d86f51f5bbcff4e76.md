...
There are numerous CSS Frameworks available that can improve the styling of our apps with little effort. [Bootstrap](https://getbootstrap.com/) is the most popular CSS Framework in existence.
...
- **👉 YOU DO: Style by Element  -** Target the `<span>` element and make its text color `orange`. **(1 min)**
...
<img src="[https://i.imgur.com/77mRdUh.jpg](https://i.imgur.com/77mRdUh.jpg)">
...
Lastly, Chrome's DevTools are invaluable in helping debug among other things, CSS.  

[Here's a link to Google's docs that discuss inspecting and changing CSS](https://developer.chrome.com/docs/devtools/css/)