...
![](https://i.imgur.com/cIz3Qx8.png)

# Build A Game - Rock Paper Scissors

## Intro

Before heading off to explore more aspects of JS, let's write a browser-based game together from start to finish (hopefully).
...
![](https://i.imgur.com/mJe7SQW.png)

## Setup

So that we don't have to spend too much time typing in HTML & CSS, we have some starter code...

Please fork and clone this repo, it provides some starter code for this RPS code along.

[https://github.com/SEIR-221-Resources/RPS-Build-A-Game](https://github.com/SEIR-221-Resources/RPS-Build-A-Game)
...
As we code together, for the most part, we'll follow these steps:
...
5. Code the countdown timer (stretch).