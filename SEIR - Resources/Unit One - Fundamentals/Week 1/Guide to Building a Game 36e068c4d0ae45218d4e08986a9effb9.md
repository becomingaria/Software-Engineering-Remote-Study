# Guide to Building a Game

![](https://i.imgur.com/QBi5aLq.png)
...
**Data** is the *single-source of truth* of an application!
...
The View can be made to "listen" for user interaction such as a click by adding *event listeners* to DOM elements.
...
- **Review:** Game State Flow Chart
    
    ![](https://i.imgur.com/jayaYY2.png)
...
***What state needs to be updated and how?***<br>
...
For example, let's say you wanted to limit the number of guesses in a game to a certain number.
...
1. **Analyze the app's functionality**
    ...
    **As a [role], I want [feature] because [reason]**.
    ...
    Example user story: *As a player, I want to see a list of high-scores so that I know what I have to score to make the list*.
...
1. **Organize the app's JS into sections**
